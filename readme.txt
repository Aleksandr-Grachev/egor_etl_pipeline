...
Чтобы установить зависимость в VS CODE:
В консоли Python вписать - pip install [имя зависимости]

PyCharm:
В найстройках проекта найти зависимости, нажать кнопку '+', найти и установить нужную зависимость
